...
app.use(flash());
app.use(helmet()); //automatically enables all of the middlewares instead of doing each one. See  https://helmetjs.github.io/
  ...
  helmet.contentSecurityPolicy({
    directives: {
      ...
      imgSrc: [
        ...
        "blob:",
        "data:",
        "https://res.cloudinary.com/deedvudwx/", //The name comes from cloudinary
